...
driver_dict = pickle.load(open('C:/Users/riddh/OneDrive/Desktop/CDAC-DBDA/dictionary/driver_dict','rb'))
constructor_dict = pickle.load(open('C:/Users/riddh/OneDrive/Desktop/CDAC-DBDA/dictionary/constructor_dict','rb'))
clf = pickle.load(open('C:/Users/riddh/OneDrive/Desktop/CDAC-DBDA/raoforest.pkl','rb'))

data = pd.read_csv("C:/Users/riddh/OneDrive/Desktop/CDAC-DBDA/cleaned_data.csv")
